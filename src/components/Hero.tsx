          ...
          <div className="animate-fade-in">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed">
                <span className="font-semibold text-blue-600">Front-End Developer</span> & <span className="font-semibold text-indigo-600">UI/UX Enthusiast</span>
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button 
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center justify-center gap-2"
              >
                View My Work
              </button>
              <button 

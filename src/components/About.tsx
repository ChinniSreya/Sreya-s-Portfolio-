      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-2xl p-6 mt-8">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl p-1">
              <div className="bg-white rounded-2xl p-8 h-full">
                <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-xl overflow-hidden relative h-96">
                  <img 
